...
| Unit | Weeks | Focus |
|------|-------|-------|
| Foundations | 1–3 | Why words matter in data — naming, schemas, content design principles |
| SQL as a Content Skill | 4–6 | Query literacy, validation, aggregation as editorial judgment |
| The Semantic Layer | 7–9 | From glossary to semantic model — dbt, Fabric, metrics design |
| Data Products Need Content Design | 10–12 | Data catalogs, writing for AI agents, the data product audit |
| Capstone | 13–14 | Build and present a fully documented, validated data product |
